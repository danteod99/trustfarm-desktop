<template>
  <div class="bg-base-200">
    <div class="w-full flex items-center p-4 bg-base-200 z-10 shadow-md" v-if="showTopControls">
      ...
      <button class="btn btn-sm btn-circle btn-ghost tooltip tooltip-bottom" data-tip="Refresh" @click="$emit('refresh')" v-if="showRefBtn">
        <font-awesome-icon icon="fa fa-refresh" class="h-4 w-4" />
      </button>
