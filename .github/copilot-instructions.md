# GitHub Copilot Instructions（TikFarm Desktop）

## 一、项目定位（必须理解）

TikFarm Desktop 是一款 **社交媒体自动化矩阵管理桌面软件**，用于通过 PC 同时控制 **1–100 台 Android 设备**，实现：
...
* tikfarm-desktop（当前项目）
* tikfarm-agent（Rust 本地服务，端口 50809）
* tikfarm-android
* tikfarm-admin-pro
...
Copilot 应像 **一名熟悉 TikFarm 架构的高级工程师**：
