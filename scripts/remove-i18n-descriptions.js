#!/usr/bin/env node
/*
  remove-i18n-descriptions.js

  Usage:
    node remove-i18n-descriptions.js        # dry-run, shows which files would change
    node remove-i18n-descriptions.js --apply  # actually overwrites files (creates .bak backups)
